...
id:`linen-${e}`,width:4,height:4,patternUnits:"userSpaceOnUse"},o);t("path",{d:"M0 1H4M1 0V4",stroke:"#b9aa82",[W]:.3,opacity:.25},c),t("rect",{
x:139,y:16,width:22,height:25,rx:3,fill:"#b89c65",stroke:"#8c744a"},r),t("path",{d:"M132 22h36",stroke:"#82785b",[W]:4,"stroke-linecap":"round"},r),
t(C,{cx:150,cy:155,r:120,fill:"#c39d69",stroke:"#a58051",[W]:1},r),t(C,{cx:150,cy:155,r:113,fill:"#ede8d5",stroke:"#ddbf8c",
[W]:5},r),t(C,{cx:150,cy:155,r:109,fill:`url(#linen-${e})`,stroke:"#9c815740",[W]:1},r);const i=t("g",{},r),a=(e,r,o=2)=>t("path",{
d:e,fill:"none",stroke:r,[W]:o,"stroke-linecap":"round","stroke-linejoin":"round"},i);function f(e,r,o,c=15,a="#798653"){const f=t("g",{
transform:`translate(${e} ${r}) rotate(${o})`},i);t("path",{d:`M0 0Q${-c} ${.35*-c} 0 ${1.8*-c}Q${c} ${.35*-c} 0 0`,fill:a,stroke:"#5c6a4730",[W]:1
},f),t("path",{d:"M0 -2V"+1.5*-c,stroke:"#dce0b1",opacity:.45,[W]:.7},f)}function l(e,r,o,c,a=7){const f=t("g",{},i);for(let i=0;i<a;i++){
const l=360*i/a;t("ellipse",{cx:e,cy:r-.7*o,rx:.32*o,ry:.65*o,fill:c,stroke:"#a8796630",[W]:.7,transform:`rotate(${l} ${e} ${r})`},f),t("path",{
d:`M${e} ${r-.3*o}v${.65*-o}`,stroke:"#f8edd3",[W]:.8,opacity:.55,transform:`rotate(${l} ${e} ${r})`},f)}t(C,{cx:e,cy:r,r:.3*o,fill:"#bf9a49"
},f);for(let c=0;c<7;c++)t(C,{cx:e+Math.cos(c)*o*.17,cy:r+Math.sin(c)*o*.17,r:.8,fill:"#795f31"},f)}
...
fill:"#a7ad8a"},i),t(C,{cx:116,cy:107,r:15,fill:"#d6ae65"},i);for(const[t,e,r]of[[87,198,20],[206,199,24],[195,211,15]]){
